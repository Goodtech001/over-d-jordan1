        ...
        listcarts.forEach(products  => {
            if(products){
                ...
                ` <img src="${products.image}" alt="">
                    ...
                    <div class="returnPrice">&#x20A6;${parseFloat(products.price) * products.quantity}</div>`;
                    listcartsHTML.appendChild(newP);
                    totalQuantity = totalQuantity + products.quantity;
                    totalPrice = totalPrice + (parseFloat(products.price) * products.quantity);
}
        })
    }
    totalQuantityHTML.innerText = totalQuantity;
    totalPriceHTML.innerText = totalPrice.toFixed(0);
}